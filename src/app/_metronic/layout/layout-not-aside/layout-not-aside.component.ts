...
import {LayoutInitService} from '@app/_metronic/layout/core/layout-init.service';
import {LayoutService} from '@app/_metronic/layout';
import {OAuthService} from 'angular-oauth2-oidc';
import {AuthService} from '@node_modules/@abp/ng.core';

@Component({
  templateUrl: './layout-not-aside.component.html',
  styleUrls: ['./layout-not-aside.component.scss']
})
export class LayoutNotAsideComponent implements OnInit {
