...
@Pipe({
  name: 'donViTinhGiaDisplayText'
})
export class DonViTinhGiaPipe implements PipeTransform {
  ...
  transform(value: string | number): Observable<string> {
    const namePipe = 'donViTinhGia';
    this.dataService.getDataOptions(this.proxy.donViTinhBangGia(), namePipe);
